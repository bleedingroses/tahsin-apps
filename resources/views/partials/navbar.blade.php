    ...
    <div class="preloader">
        <div class="loader">
            ...
            <p class="loader__label">Tahsin</p>
        </div>
    </div>
    <!-- ============================================================== -->
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="/">
                        <!-- Logo icon --><b>
                            ...
                            <!-- Light Logo icon -->
                            <img src="{{ asset('assets/images/tahsin-fix3.png') }}" width="90" alt="homepage" />
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text --><span>
                         <!-- Light Logo text -->
                         <img src="{{ asset('assets/images/tafio-fix.png') }}" width="125" alt="homepage" /></span>
                    </a>
                </div>
                <!-- ============================================================== -->
                <!-- End Logo -->
